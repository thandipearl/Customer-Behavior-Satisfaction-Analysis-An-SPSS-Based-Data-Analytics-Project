...
# Customer Behavior & Satisfaction Analysis (SPSS Project)

## Project Overview

This project explores customer behavior and satisfaction within a retail environment using SPSS. 

The main goal was to understand:
- Who the customers are  
- How they spend  
- What actually drives their satisfaction  

Instead of just looking at numbers, this analysis focuses on turning data into **real business insights** that can improve decision-making.
...
**What this means:**
Improving the **customer experience** and encouraging repeat visits is more important than targeting high-income customers.
...
The dataset used in this project contains 500 customer records with variables such as:
- Age  
- Gender  
- Income  
- Spending Score  
